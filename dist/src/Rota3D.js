...
var Rota3D = /** @class */ (function () {
    ...
    */
    ...
    Rota3D.rotate = function (p) {
        var desplazar = 0.5;
        return new Point3D(p.x * this.r11 + p.y * this.r21 + p.z * this.r31 + this.r41 - desplazar, p.x * this.r12 + p.y * this.r22 + p.z * this.r32 + this.r42 - desplazar, p.x * this.r13 + p.y * this.r23 + p.z * this.r33 + this.r43);
    };
    return Rota3D;
}());
export { Rota3D };
